...
if (isset($_POST['simpan'])) {
    ...
    /*
    $gambar = $_FILES['gambar']['name']; // gambar untuk ambil nama
    $temp_nammer = $_FILES['gambar']['name'];// penyimpanan sementara
    $path = "img/"; // location
    move_uploaded_file($path, $path . $gambar);// memindahkan gambar
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        if ($ukuran < 1044070) {
            ...
            if (move_uploaded_file($file_tmp, $target_file)) {
                ...
                $simpan = mysqli_query($koneksi, "INSERT INTO `myproject`(`tittle`, `text`,`gambar`) VALUES ('$tittle','$deskripsi','$nama_file')");
        ...
        <div class="container" style="margin-top:4rem">
            <div class="row ">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tittle" name="deskripsi">
                </div>
                <div class="mb-3">
